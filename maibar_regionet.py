...
date=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_constco2_constcli_rf_nofert_0.5x0.5.nc','r')
iyield1ynewe = date.variables['totalyield'][95:105,:,:]

dat2e=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_constco2_constcli_irrig_nofert_0.5x0.5.nc','r')
iyield2ynewe = dat2e.variables['totalyield'][95:105,:,:]

dat3e=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_constco2_constcli_rf_fert_0.5x0.5.nc','r')
iyield3ynewe = dat3e.variables['totalyield'][95:105,:,:]

dat4e=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_co2_constcli_rf_nofert_0.5x0.5.nc','r')
iyield4ynewe = dat4e.variables['totalyield'][95:105,:,:]

dat5e=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_constco2_cli_rf_nofert_0.5x0.5.nc','r')
...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/heat/fixedirr_fertfao_new/equilibrium/maiequilibrium/output/maiequilibrium_evp.nc','r')
eiyield1ynewe = dat.variables['g_ET'][95:105,0,:,:]

dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/heat/fixedirr_fertfao_new/equilibrium/maiequilibrium_irr/output/maiequilibrium_irr_evp.nc','r')
eiyield2ynewe = dat2.variables['g_ET'][95:105,0,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/heat/fixedirr_fertfao_new/equilibrium/maiequilibrium_fert/output/maiequilibrium_fert_evp.nc','r')
eiyield3ynewe = dat3.variables['g_ET'][95:105,0,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/heat/fixedirr_fertfao_new/equilibrium/maiequilibrium_co2/output/maiequilibrium_co2_evp.nc','r')
eiyield4ynewe = dat4.variables['g_ET'][95:105,0,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/heat/fixedirr_fertfao_new/equilibrium/maiequilibrium_cli/output/maiequilibrium_cli_evp.nc','r')
eiyield5ynewe = dat5.variables['g_ET'][95:105,0,:,:]
...
#	allyclinew=N.average(iyield5ynew/eiyield5ynew*mmarea*10000/gridarea2,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        allynew=N.average(eiyield1ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        allyinew=N.average(eiyield2ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        allynnew=N.average(eiyield3ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        allycnew=N.average(eiyield4ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        allyclinew=N.average(eiyield5ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
...
#        eallyclinewe=N.average(iyield5ynewe/eiyield5ynewe*mmarea*10000/gridarea2,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        eallynewe=N.average(eiyield1ynewe,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        eallyinewe=N.average(eiyield2ynewe,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        eallynnewe=N.average(eiyield3ynewe,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        eallycnewe=N.average(eiyield4ynewe,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        eallyclinewe=N.average(eiyield5ynewe,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
...
allynew=N.average(eiyield1ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
allyinew=N.average(eiyield2ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
allynnew=N.average(eiyield3ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
allycnew=N.average(eiyield4ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
allyclinew=N.average(eiyield5ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
...
eallynewe=N.average(eiyield1ynewe,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
eallyinewe=N.average(eiyield2ynewe,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
eallynnewe=N.average(eiyield3ynewe,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
eallycnewe=N.average(eiyield4ynewe,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
eallyclinewe=N.average(eiyield5ynewe,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
...
plt.savefig('mai_region_et_all1.png')
plt.show()
