...
plt.ylabel('Effect on maize ET (%)',fontsize=18)
...
ax.plot_date(xdates,allynewe,"y-",label=" $S_{all}$",linewidth='3')
ax.plot_date(xdates,allycnewe,"k-",label=" $S_{CO2}$",linewidth='3')
ax.plot_date(xdates,allyclinewe,"r-",label="$S_{Climate}$",linewidth='3')
ax.plot_date(xdates,allynnewe,"g-",label=" $S_{NF}$",linewidth='3')
ax.plot_date(xdates,allyinewe,"b-",label=" $S_{Irrigation}$",linewidth='3')
plt.xlim(xdates[1],xdates[104])
...
plt.ylabel('Maize ET (mm)',fontsize=18)
...
plt.savefig('maihis_et_1902_2005.png')
plt.show()
