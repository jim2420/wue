...
iyield1y = N.average(dat.variables['total_gWS'][95:105,:,:],axis=0)
iyield1ynew = dat.variables['total_gWS'][0:105,:,:]
...
iyield2y = N.average(dat2.variables['total_gWS'][95:105,:,:],axis=0)
iyield2ynew = dat2.variables['total_gWS'][0:105,:,:]
...
iyield3y = N.average(dat3.variables['total_gWS'][95:105,:,:],axis=0)
iyield3ynew = dat3.variables['total_gWS'][0:105,:,:]
...
iyield4y = N.average(dat4.variables['total_gWS'][95:105,:,:],axis=0)
iyield4ynew = dat4.variables['total_gWS'][0:105,:,:]
...
iyield5y = N.average(dat5.variables['total_gWS'][95:105,:,:],axis=0)
iyield5ynew = dat5.variables['total_gWS'][0:105,:,:]
...
iyield6y = N.average(dat6.variables['total_gWS'][95:105,:,:],axis=0)
iyield6ynew = dat6.variables['total_gWS'][0:105,:,:]
...
plt.ylabel('Effect on ws (%)',fontsize=18)
...
plt.ylabel('Maize ws',fontsize=18)
...
plt.savefig('maihis_ws_1902_2005.png')
plt.show()
