...
iyield1yne = dat.variables['g_ET'][95:105,1,:,:]
...
iyield2yne = dat2.variables['g_ET'][95:105,1,:,:]
...
iyield3yne = dat3.variables['g_ET'][95:105,1,:,:]
...
iyield4yne = dat4.variables['g_ET'][95:105,1,:,:]
...
iyield5yne = dat5.variables['g_ET'][95:105,1,:,:]
...
wue1=iyield1*1000/(iyield1e)
wue2=iyield2*1000/(iyield2e)
wue3=iyield3*1000/(iyield3e)
wue4=iyield4*1000/(iyield4e)
wue5=iyield5*1000/(iyield5e)
...
cs1 = map.pcolormesh(x,y,cc,cmap=cmap,norm=norm)
#cbar = map.colorbar(cs1,location='right',size="5%",pad="2%",extend='both')
#cbar.ax.tick_params(labelsize=15)
...
cs1 = map.pcolormesh(x,y,dd,cmap=cmap,norm=norm)
...
#dd= ma.masked_where(dd==0,dd)
ee=wue1
ee= ma.masked_where(ee<=0,ee)

cs1 = map.pcolormesh(x,y,ee,cmap=cmap,norm=norm)
...
plt.savefig('soy_1996_2005_wue.jpg',dpi=300,bbox_inches='tight')
plt.show()
