...
ax.scatter(fertr,finalnnew,c='black',alpha=1)
...
rr=r_value**2
ax.annotate('y = {:04.2f} x'.format(slope), xy=(0.04, 0.10),xycoords='axes fraction',fontsize=18,color='blue')
...
ax.scatter(fertr,wfinalnnew,c='black',alpha=1)
plt.xlabel('Relative change in NF (%)',fontsize=16)
...
plt.savefig('maihis_wue_1902_2005_s.png')
plt.show()
