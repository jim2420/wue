...
ax.plot_date(xdates,wfinalcnew,"k-",label=r"$\Delta$ CO$_{2}$",linewidth='3')
ax.plot_date(xdates,wfinalclinew,"r-",label=r"$\Delta$ Climate",linewidth='3')
ax.plot_date(xdates,wfinalnnew,"g-",label=r"$\Delta$ NF",linewidth='3')
ax.plot_date(xdates,wfinalinew,"b-",label=r"$\Delta$ Irrigation",linewidth='3')
...
plt.ylabel('Effect on maize WUE (%)',fontsize=18)
...
ax.plot_date(xdates,allynewew,"y-",label=" $S_{all}$",linewidth='3')
ax.plot_date(xdates,allycnewew,"k-",label=" $S_{CO2}$",linewidth='3')
ax.plot_date(xdates,allyclinewew,"r-",label="$S_{Climate}$",linewidth='3')
ax.plot_date(xdates,allynnewew,"g-",label=" $S_{NF}$",linewidth='3')
ax.plot_date(xdates,allyinewew,"b-",label=" $S_{Irrigation}$",linewidth='3')
plt.xlim(xdates[1],xdates[104])
...
plt.ylabel('Maize WUE (kg grain/ha/mm)',fontsize=18)
...
plt.savefig('maihis_wue_1902_2005.png')
plt.show()
