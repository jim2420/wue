...
ax.scatter(fertr,finalcnew,c='black',alpha=1)
plt.xlabel('Relative change (%)',fontsize=16)
plt.ylabel('Relative change in yield (%)',fontsize=16)
plt.tick_params(axis='both',labelsize=16)

slope, intercept, r_value, p_value, std_err = stats.linregress(fertr,finalcnew)
...
ax.scatter(fertr,wfinalcnew,c='black',alpha=1)
plt.xlabel('Relative change (%)',fontsize=16)
plt.ylabel('Relative change in UWE (%)',fontsize=16)
plt.tick_params(axis='both',labelsize=16)

slope, intercept, r_value, p_value, std_err = stats.linregress(fertr,wfinalcnew)
line = slope*fertr+intercept
ax.plot(fertr,line,linewidth=2.0)
rr=r_value**2
ax.annotate('y = {:04.2f} x'.format(slope), xy=(0.04, 0.10),xycoords='axes fraction',fontsize=18,color='blue')
...
ax.scatter(fertr,etfinalcnew,c='black',alpha=1)
plt.xlabel('Relative change (%)',fontsize=16)
plt.ylabel('Relative change in ET (%)',fontsize=16)
plt.tick_params(axis='both',labelsize=16)

slope, intercept, r_value, p_value, std_err = stats.linregress(fertr,etfinalcnew)
line = slope*fertr+intercept
ax.plot(fertr,line,linewidth=2.0)
rr=r_value**2
ax.annotate('y = {:04.2f} x'.format(slope), xy=(0.04, 0.10),xycoords='axes fraction',fontsize=18,color='blue')
...
plt.savefig('maihis_wue_1902_2005_co2.png')
plt.show()
